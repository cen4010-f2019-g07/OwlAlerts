...
exports.issue_list = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_detail = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_create_get = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_create_post = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_delete_get = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_delete_post = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_update_get = function(err, req, res, next) {
	if(err)
		next(err);
...
exports.issue_update_post = function(err, req, res, next) {
	if(err)
		next(err);
